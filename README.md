...
5. Run 'pio run -t upload' (If You are Using Windows Run '"%AppData%\Python\Python**314**\Scripts\pio.exe" run -t upload')

6. If You Want to Debug by USB Cable Run 'pio device monitor --baud 115200' (If You are Using Windows Run '"%AppData%\Python\Python**314**\Scripts\pio.exe" monitor --baud 115200')
